...
Цей бот дозволяє вам шукати публічні канали та групи, а також переглядати, в яких публічних чатах знаходиться або був користувач, використовуючи базу даних, яка постійно оновлюється з <b>більш ніж 200 мільйонами чатів і більш ніж 600 мільйонами користувачів!</b>
...
/resolve [id o username] - <code>Розв'язати ім'я користувача або ID</code>
/search [nome] - <code>Пошук груп та каналів</code>
/group [nome] - <code>Пошук груп</code>
/channel [nome] - <code>Пошук каналів</code>

\u{1F4B2} <b>Преміум управління:</b>
/where [id o username] - <code>Пошук груп користувача</code>
...
|]1,Inf[У вас недостатньо кредитів для виконання пошуку.\nВам потрібно %price% кредитів, але у вас тільки %count% кредитів.\nВи можете купити їх за допомогою /credits",
    ...
    "ref_invalid"         => "Реферал, який ви намагаєтеся використовувати, недійсний.",
    "ref_self"            => "Ви не можете використовувати свій власний реферал.",
    "ref_already_used"    => "Ви вже використали реферал, не можете використовувати інші.",
    "ref_promo_max_usage" => "Цей реферал вже використовувався занадто багатьма людьми, однак, ви зможете отримати %credits% безкоштовних кредитів при вашому першому покупці завдяки цьому рефералу.",
    "ref_already_created" => "Ви вже створили свій власний реферал, не можете використовувати інші.",
    "ref_had_credits"     => "Ви вже використали бот, ви не можете використовувати цей реферал, але ви можете запросити друга за допомогою вашого рефералу, виконайте /referral та надішліть йому посилання.",
    ...
    "ref_ok_error_api"    => "Реферал дійсний, але не вдалося додати кредити, спробуйте пізніше, якщо помилка виникає знову, зверніться до служби підтримки за допомогою /support",
    "ref_ok_generated"    => "Ваш реферал був створений, надішліть його своїм друзям, і ви обидва отримаєте %credits% кредитів, коли запрошений здійснить перший покупку.\n\nПосилання запрошення: https://t.me/%username%?start=%ref%",
    "ref_error_generated" => "На жаль, ви не можете створювати посилання запрошення, якщо ви ніколи не здійснювали покупок.",
];
